...
const initialExpenseCategoriesDisplayData: ExpenseCategoryDisplayData[] = (Object.keys(expenseCategoryConfig) as Array<keyof typeof expenseCategoryConfig>).map((categoryKey, index) => {
    const colors = [
        ...
        { pieFill: "hsl(340 80% 78%)", bgColor: "bg-pink-100 dark:bg-pink-900/30", textColor: "text-pink-700 dark:text-pink-300", borderColor: "border-pink-300 dark:border-pink-700" },
        { pieFill: "hsl(50 75% 72%)", bgColor: "bg-yellow-100 dark:bg-yellow-900/30", textColor: "text-yellow-700 dark:text-yellow-300", borderColor: "border-yellow-300 dark:border-yellow-700" },
        { pieFill: "hsl(20 75% 75%)", bgColor: "bg-red-100 dark:bg-red-900/30", textColor: "text-red-700 dark:text-red-300", borderColor: "border-red-300 dark:border-red-700" },
        ...
        { pieFill: "hsl(30 80% 72%)", bgColor: "bg-orange-100 dark:bg-orange-900/30", textColor: "text-orange-700 dark:text-orange-300", borderColor: "border-orange-300 dark:border-orange-700" },
    ];
